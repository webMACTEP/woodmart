...
// function get_brand_link() {
// 	$link = '/brand/';
// 	$brand = strtolower($product->get_attribute('brand'));
...
<div class="product-wrapper">
	...
	<div class="product-information">
		<div class="product-information-brand">
			<a href="/brand/<?= str_replace(" ","-", strtolower($product->get_attribute('brand'))) ?>" class="product-information-brand__link">
				<b><?= $product->get_attribute('brand') ?></b>
			</a>
		</div>
		<?php
		...
		?>
		<div class="product-information-size">
